...
def main(iargs=None):
    ...
    CSK_extensions = (os.path.join(inputDir, 'EL*.zip'),os.path.join(inputDir, 'EL*.tar'),os.path.join(inputDir, 'CSKS*.gz'))
    for CSK_extension in CSK_extensions:
        ...
        CSK_folders = glob.glob(os.path.join(inputDir, 'CSKS*'))
