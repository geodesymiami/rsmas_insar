...
For a full list of different options, try stack_run.py -h
...
going on, after running stack_run.py, look at each run file generated by stack_run.py in 
...
Example:
stack_run.py -s ../merged/SLC/ -w ./ -b '19 20 -99.5 -98.5' -wra 21 -waz 15 
'''
##############################################
