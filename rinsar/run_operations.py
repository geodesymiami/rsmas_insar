...
from rinsar import generate_template_files
...
def run_process_rsmas(inps, template_file, dataset, newest_date):
    """
    ...
    :param newest_date: the newest date bring processed to send to process_rsmas to properly update the stored_date file
    ...
    for dset in datasets:
        ...
        if newest_date > last_date:
            ...
            try:
                ...
                outputs, job = run_process_rsmas(inps, template_file, dset, newest_date)
